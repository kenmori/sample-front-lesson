...
const isMatchPasswordFields = () =>
  passwordOfInput.value === confirmPasswordOfInput.value;
const hasInvalidClass = () =>
  formElements.some((element) => element.classList.contains('invalid'));
const confirmIfCanSubmit = (input, confirmInput) =>
  (submitButton.disabled = input.value !== confirmInput.value);
...
formElements.forEach((element) => {
  ...
  element.addEventListener('blur', (e) => {
    ...
    errorOfConfirmPassword.textContent = isMatchPasswordFields()
      ? ''
